...
const OsasunaFC = images.find((img) => img.id === 22); // Replace with actual ID
const AtalantaBC = images.find((img) => img.id === 31); // Replace with actual ID
const NewcastleUnited = images.find((img) => img.id === 18); // Replace with actual ID
const AlFateh = images.find((img) => img.id === 28); // Replace with actual ID

const matches = [
  { team1: OsasunaFC, team2: AtalantaBC },
  { team1: NewcastleUnited, team2: AlFateh },
  { team1: OsasunaFC, team2: NewcastleUnited },
  { team1: AtalantaBC, team2: AlFateh },
  { team1: OsasunaFC, team2: AlFateh },
  { team1: AtalantaBC, team2: NewcastleUnited },
];
...
<h1 className='font-mono text-2xl'>Group H</h1>
<div className="team flex justify-around items-center mt-4">

<img src={OsasunaFC.src}/>
<img src={AtalantaBC.src}/>
<img src={NewcastleUnited.src}/>
<img src={AlFateh.src}/>
</div>
     </div>
